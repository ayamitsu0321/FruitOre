...
public class FruitOreObject {
	...
	static {
		...
		fruitsList[Block.oreDiamond.blockID] = new FOODiamond(Block.oreDiamond.blockID).setFruitColor(0x6dcefb);
		fruitsList[Block.oreLapis.blockID] = new FOOLapis(Block.oreLapis.blockID).setFruitColor(0x1542cc);
		fruitsList[Block.oreRedstone.blockID] = new FOORedstone(Block.oreRedstone.blockID).setFruitColor(0xaa0404);
		fruitsList[Block.oreEmerald.blockID] = new FOOEmerald(Block.oreEmerald.blockID).setFruitColor(0x24af5a);
		fruitsList[Block.glowStone.blockID] = new FOOGrowstone(Block.glowStone.blockID).setFruitColor(0xffbc5e);
		fruitsList[Block.oreNetherQuartz.blockID] = new FOONetherQuartz(Block.oreNetherQuartz.blockID).setFruitColor(0xe7e1d8);
		fruitsList[Block.oreCoal.blockID] = new FOOCoal(Block.oreCoal.blockID).setFruitColor(0x343434);
	}
